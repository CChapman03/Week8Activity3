...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements com.ciaranchapman.week8activity3.NdfdXML {
 ...
 */
    ...
    public com.ciaranchapman.week8activity3.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.ciaranchapman.week8activity3.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ciaranchapman.week8activity3.NdfdXMLBindingStub _stub = new com.ciaranchapman.week8activity3.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ciaranchapman.week8activity3.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ciaranchapman.week8activity3.NdfdXMLBindingStub _stub = new com.ciaranchapman.week8activity3.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
